...
export default function About() {
  ...
  return (
    ...
    <section className=' bg-main relative h-auto overflow-hidden  ' >
        ...
        <h3 className='   font-bold text-2xl lg:text-4xl my-2 text-basic fontStyle text-center'>
       Countdown For Next Festival
        ...
        <div className=' absolute lg:top-10  top-14 floating left-0 '>
...
<Image src={neon} alt='svg'  className='lg:size-52 size-28'/>
    ...
    <div className='lg:container floating  lg:mx-auto relative mx-5'>
        <div className="w-full flex items-center flex-col ">
        <h3 className='   font-bold text-2xl lg:text-4xl my-2 text-basic fontStyle'>
       About Us 
        </h3>
...
Careful planning for unforgettable events and events!
        ...
        <h2 className='text-basic text-xl lg:text-3xl font-bold text-center fontStyle' >
    ...
    <h2 className='text-basic text-xl lg:text-3xl font-bold text-center my-3 fontStyle '>
        Meet Us there !
        </h2>
